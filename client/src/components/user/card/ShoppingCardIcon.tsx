...
const ShoppingCardIcon = () => {
    ...
    useEffect (() => {
        ...
        const itemsFromLocalStorage = getItemFromLocalStorage<CardItem[]>("card_items");

        if (itemsFromLocalStorage != null) {

            setCardItems(itemsFromLocalStorage);
    ...
    return (
        <>
            <div className="indicator">
                ...
                <span className="indicator-item badge w-2 h-5">{cardItems.length}</span>
